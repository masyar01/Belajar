...
<div class="tentor-form">
    ...
    <?= $form->field($model, 'sex')->dropdownList(Tentor::isSex()) ?>
    ...
    <?= $form->field($model, 'status')->dropdownList(Tentor::isStatus()) ?>

    <?= $form->field($model, 'is_active')->dropdownList(Tentor::isActive()) ?>

    <?= $form->field($model, 'is_validate')->dropdownList(Tentor::isValidate()) ?>
